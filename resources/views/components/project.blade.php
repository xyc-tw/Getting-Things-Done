...
<div class="@if($project->name == 'stuffs') row-span-2 @else row-span-1 @endif p-6 border border-gray-100 rounded-xl bg-gray-50 flex-col p-6 relative card firststep overflow-y-hidden">
